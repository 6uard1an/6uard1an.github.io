var copyrightNotice =
  "This game is the exclusive property of licensed to Zyis Limited (owners and operators of DeathChase.com). Unauthorized hosting is strictly prohibited.";
...
function UnityProgress(gameInstance, progress) {
  ...
  if (!gameInstance.DeathChase) {
    gameInstance.DeathChase = document.createElement("div");
    gameInstance.DeathChase.className =
      "DeathChase " + gameInstance.Module.splashScreenStyle;
    gameInstance.container.appendChild(gameInstance.DeathChase);
  }
  ...
  if (!gameInstance.spinner) {
    ...
    gameInstance.spinner.className =
      "spinner " + gameInstance.Module.splashScreenStyle;
  ...
  if (progress >= 1 && anim == false) {
    ...
    setTimeout(function () {
      gameInstance.logo.style.display = gameInstance.progress.style.display =
        "none";
      gameInstance.spinner.style.display = "none";
      gameInstance.DeathChase.style.display = "none";
    }, 100);
  }
}
